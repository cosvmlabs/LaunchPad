          ...
          <div>
            <div className="row">
              <div className="col-lg-6">
                <input
                  type="text"
                  placeholder={`Token Balance: ${detail?.supply
              ...
              <div className="col-lg-12">
                <textarea name="message" cols="30" rows="10" disabled
                placeholder={`Current Price: ${detail?.tokenBal} ${detail?.symbol} Token Address: ${detail?.tokenBal}${shortenAddress(detail?.tokenAddr)}`}></textarea>
              </div>
              <div className="ico-contract__btn text-center mt-10">
                <button onClick={() => BUY_TOKEN(amount)}
                  className="thm-btn" >
                  Buy Token
                </button>
              </div>
