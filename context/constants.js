...
export const TOKEN_ADDRESS = "0x8d99b68Bb465a0e339bA16aD4feF609f69ce4535";
export const ERC20_ABI = erc20.abi;

export const OWNER_ADDRESS = "0x7d053cec3B95F1D88c7c27EC9B25D5588C15D9EF";

export const CONTRACT_ADDRESS = "0xECC1De7646f6Be524396872e6e8cE20664fbb10F";
...
export const CHECK_WALLET_CONNECTED = async () => {
  ...
  if (account.length) {
    ...
    console.log("Please Install MetaMask & Connect, Realod");
  }
};
...
export const addtokenToMetaMask = async () => {
  if (window.ethereum) {
    ...
    const tokenImage = "http://bit.ly/4jazCzM";
